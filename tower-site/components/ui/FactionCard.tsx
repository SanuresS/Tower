  ...
  return (
    ...
    >
      ...
      <div className="p-5 pt-4">
        ...
        {/* Relations block */}
        <div className="mt-4 p-3 rounded-md border border-dashed border-tower-border/40 bg-white/[0.02]">
          <div className="flex items-center gap-2 mb-2.5">
            <svg width="12" height="12" viewBox="0 0 16 16" fill="none" className="opacity-40 shrink-0">
                ...
                <div className="flex gap-0.5 flex-1">
                  {relationToneOrder.map((tone, j) => (
                    <div
                      ...
                      style={{ backgroundColor: `${relationToneColors[tone]}40` }}
                    />
                  ))}
                </div>
                <div className="flex gap-1 w-20 justify-end">
                  <span className="text-[7px] font-mono text-tower-muted/30">Союз</span>
                  <span className="text-[7px] font-mono text-tower-muted/30">Вражда</span>
                </div>
              </div>
            </div>
          ) : (
