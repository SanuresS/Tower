...
export const creatures: Creature[] = [
  ...
  },
  {
    ...
    dangerLevel: 2,
    description:
      "Особая редкая разновидность призраков. Светящиеся белые человеческие фигуры. Если прикоснуться — сущность на мгновение начнёт очень сильно светиться, а после исчезнет вместе с человеком. Являются остаточными проявлениями цифрового сознания Бога.",
  ...
  },
  {
    ...
    encounter: { upper: 5, middle: 3, lower: 0 },
  },
  {
    id: "devils",
    name: "Черти",
  ...
  },
  {
    ...
    dangerLevel: 4,
    description:
      "Люди, чьи голосовые связки были полностью разрушены длительным воздействием Голоса Бога. Их голос был уничтожен, и они издают только хрипящие звуки. Четвероногая массивная морфология. Частый случай био-автоматона. Грибок заполнил ремонтную платформу, обрастая мозгоподобной нервной системой. Цель — заражать спорами электронику. Встречаются возле сети ЦСУ.",
    tags: ["био-механика", "споры", "заражение", "голосовые связки разрушены"],
  ...
  },
  {
    ...
    dangerLevel: 3,
    description:
      "Плотоядные существа, похожие на грызунов, но размером с человека. Имеют острые когти и клыки, стаями охотятся на людей и других существ. Био-автоматон, поражённый мицелием Хрипуна, но не подключённый к сети ЦСУ. Меньше и слабее Хрипуна, но обладает высокой скоростью и манёвренностью.",
    tags: ["быстрые", "хищники", "стаи", "когти"],
